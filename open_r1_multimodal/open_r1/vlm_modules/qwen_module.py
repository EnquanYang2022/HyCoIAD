...
from open_r1_multimodal.open_r1.vlm_modules.qwen2_5vl_module_HpyCo import Qwen2_5_VLForConditionalGenerationHpyCo
...
class Qwen2VLModule(VLMBaseModule):
    ...
    def get_model_class(self, model_id: str, model_init_kwargs: dict):
        if "Qwen2-VL" in model_id:
            ...
            model_cls = Qwen2_5_VLForConditionalGenerationHpyCo
        else:
