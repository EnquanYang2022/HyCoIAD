...
if __name__=="__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/mnt/data/yeq/MLLM/IAD_MMAD/checkpoints/rl/Qwen2.5-VL-3B-Instruct_RL_merge_5e-6/")
    ...
    parser.add_argument("--domain_knowledge_path", type=str, default="/mnt/data/yeq/Datasets/MMAD/domain_knowledge.json")
    ...
    answers_json_path = f"result/mymodel_answers_{args.few_shot_model}_shot_{model_name}_without_thinking.json"
    ...
    cfg = {
        "data_path": "/mnt/data/yeq/Datasets/MMAD/",
        "json_path": "/mnt/data/yeq/Datasets/MMAD/mmad.json"
    }
